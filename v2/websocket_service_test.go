...
func (s *websocketServiceTestSuite) TestWsAllMiniMarketsStatServe() {
	...
	doneC, stopC, err := WsAllMiniMarketsStatServe(func(event WsMiniMarketsStatEvent) {
...
func (s *websocketServiceTestSuite) assertWsMiniMarketsStatEventEqual(e, a *WsMiniMarketStatEvent) {
	r := s.r()
	r.Equal(e.Event, a.Event, "Event")
	r.Equal(e.Time, a.Time, "Time")
	r.Equal(e.Symbol, a.Symbol, "Symbol")
